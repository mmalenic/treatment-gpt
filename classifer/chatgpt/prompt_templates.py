...
You will have the following information available:
1. The list of pairs of possible treatments and abstracts outlining the source of the treatment. Each treatment and source pair is delimited by triple quotes. Not all treatments are correct.
2. The patient's cancer type.
3. A pair of the patient's actionable genes."""
...
You will have the following information available:
1. The list of possible treatments, delimited with square brackets. Only one treatment is correct.
...
_TREATMENT_ONLY_RESPONSE_PROMPT_TEMPLATE = """Journal abstract: {source}
